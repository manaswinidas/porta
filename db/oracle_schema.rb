...
ActiveRecord::Schema.define(version: 20190805135829) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.boolean  "provider",                                        limit: nil,                          default: false
    t.boolean  "buyer",                                           limit: nil,                          default: false
    ...
    t.string   "state"
    t.boolean  "paid",                                            limit: nil,                          default: false
    t.datetime "paid_at"
    t.boolean  "signs_legal_terms",                               limit: nil,                          default: true
    t.string   "timezone"
    t.boolean  "delta",                                           limit: nil,                          default: true,  null: false
    t.string   "from_email"
    ...
    t.boolean  "email_all_users",                                 limit: nil,                          default: false
  ...
  create_table "api_docs_services", force: :cascade do |t|
    ...
    t.text     "body"
    t.text     "description"
    t.boolean  "published",                limit: nil,                default: false
  ...
  create_table "authentication_providers", force: :cascade do |t|
    ...
    t.boolean  "trust_email",                       limit: nil,                default: false
    t.string   "kind"
    t.boolean  "published",                         limit: nil,                default: false
    t.string   "branding_state"
    t.string   "type"
    t.boolean  "skip_ssl_certificate_verification", limit: nil,                default: false
    t.string   "account_type",                                                 default: "developer", null: false
    t.boolean  "automatically_approve_accounts",    limit: nil,                default: false
  end
  ...
  create_table "billing_strategies", force: :cascade do |t|
    t.integer  "account_id",                       precision: 38
    t.boolean  "prepaid",              limit: nil,                default: false
    t.boolean  "charging_enabled",     limit: nil,                default: false
  ...
  create_table "cinstances", force: :cascade do |t|
    ...
    t.text     "extra_fields"
    t.boolean  "end_user_required",        limit: nil
    t.integer  "tenant_id",                            precision: 38
  ...
  create_table "cms_files", force: :cascade do |t|
    ...
    t.string   "path"
    t.boolean  "downloadable",            limit: nil
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "cms_sections", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "public",       limit: nil,                default: true
  ...
  create_table "cms_templates", force: :cascade do |t|
    ...
    t.text     "published"
    t.text     "draft"
    t.boolean  "liquid_enabled",  limit: nil
    ...
    t.string   "updated_by"
    t.string   "handler"
    t.boolean  "searchable",      limit: nil,                default: false
  ...
  create_table "countries", force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.integer  "tenant_id",              precision: 38
    t.boolean  "enabled",    limit: nil,                          default: true
  end
  ...
  create_table "features", force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.string   "system_name"
    t.boolean  "visible",         limit: nil,                default: true,              null: false
  ...
  create_table "fields_definitions", force: :cascade do |t|
    ...
    t.boolean  "required",   limit: nil,                default: false
    t.string   "label"
    t.string   "name"
    t.text     "choices"
    t.text     "hint"
    t.boolean  "read_only",  limit: nil,                default: false
  ...
  create_table "go_live_states", force: :cascade do |t|
    ...
    t.text     "steps"
    t.string   "recent"
    t.boolean  "finished",   limit: nil,                default: false
    t.integer  "tenant_id",              precision: 38
  end
  ...
  create_table "invoices", force: :cascade do |t|
    ...
    t.datetime "last_charging_retry"
  ...
  create_table "legal_term_versions", force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.boolean  "published",       limit: nil,                default: false
    t.boolean  "deleted",         limit: nil,                default: false
    t.boolean  "archived",        limit: nil,                default: false
  ...
  create_table "mail_dispatch_rules", force: :cascade do |t|
    ...
    t.text     "emails"
    t.boolean  "dispatch",            limit: nil,                default: true
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "tenant_id",                       precision: 38
  end
  ...
  create_table "payment_details", force: :cascade do |t|
    ...
    t.datetime "credit_card_expires_on"
    t.datetime "created_at",                                null: false
    t.datetime "updated_at",                                null: false
    t.integer  "tenant_id",                  precision: 38
  end
  ...
  create_table "payment_transactions", force: :cascade do |t|
    t.integer  "account_id",             precision: 38
    t.integer  "invoice_id",             precision: 38
    t.boolean  "success",    limit: nil,                          default: false, null: false
    ...
    t.string   "action"
    t.text     "params"
    t.boolean  "test",       limit: nil,                          default: false, null: false
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "tenant_id",              precision: 38
  end
  ...
  create_table "plan_metrics", force: :cascade do |t|
    t.integer  "plan_id",                      precision: 38
    t.integer  "metric_id",                    precision: 38
    t.boolean  "visible",          limit: nil,                default: true
    t.boolean  "limits_only_text", limit: nil,                default: true
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "plan_type",                                                  null: false
    t.integer  "tenant_id",                    precision: 38
  ...
  create_table "plans", force: :cascade do |t|
    ...
    t.boolean  "master",                limit: nil,                          default: false
    t.integer  "original_id",                       precision: 38,           default: 0,     null: false
    t.string   "type",                                                                       null: false
    t.string   "issuer_type",                                                                null: false
    t.text     "description"
    t.boolean  "approval_required",     limit: nil,                          default: false, null: false
    t.boolean  "end_user_required",     limit: nil,                          default: false, null: false
    t.integer  "tenant_id",                         precision: 38
    t.string   "system_name",                                                                null: false
    t.integer  "partner_id",                        precision: 38
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.string   "first_name"
    t.string   "last_name"
    t.boolean  "anonymous_user", limit: nil,                default: false
    t.integer  "tenant_id",                  precision: 38
  end
  ...
  create_table "services", force: :cascade do |t|
    ...
    t.integer  "logo_file_size",                             precision: 38
    t.string   "state",                                                                         null: false
    t.boolean  "intentions_required",            limit: nil,                default: false
    ...
    t.boolean  "custom_keys_enabled",            limit: nil,                default: true
    t.string   "buyer_plan_change_permission",                              default: "request"
    t.boolean  "buyer_can_select_plan",          limit: nil,                default: false
    ...
    t.boolean  "end_user_registration_required", limit: nil,                default: true,      null: false
    t.integer  "tenant_id",                                  precision: 38
    t.string   "system_name",                                                                   null: false
    t.string   "backend_version",                                           default: "1",       null: false
    t.boolean  "mandatory_app_key",              limit: nil,                default: true
    t.boolean  "buyer_key_regenerate_enabled",   limit: nil,                default: true
    t.string   "support_email"
  ...
  create_table "settings", force: :cascade do |t|
    ...
    t.boolean  "forum_enabled",                       limit: nil,                default: true
    t.boolean  "app_gallery_enabled",                 limit: nil,                default: false
    t.boolean  "anonymous_posts_enabled",             limit: nil,                default: false
    t.boolean  "signups_enabled",                     limit: nil,                default: true
    t.boolean  "documentation_enabled",               limit: nil,                default: true
    t.boolean  "useraccountarea_enabled",             limit: nil,                default: true
    t.text     "refund_policy"
    t.text     "privacy_policy"
    t.boolean  "monthly_charging_enabled",            limit: nil,                default: true
    t.string   "token_api",                                                      default: "default"
    t.boolean  "documentation_public",                limit: nil,                default: true,              null: false
    t.boolean  "forum_public",                        limit: nil,                default: true,              null: false
    t.boolean  "hide_service",                        limit: nil
    ...
    t.boolean  "strong_passwords_enabled",            limit: nil,                default: false
    t.string   "change_service_plan_permission",                                 default: "request",         null: false
    t.boolean  "can_create_service",                  limit: nil,                default: false,             null: false
    ...
    t.boolean  "public_search",                       limit: nil,                default: false,             null: false
    t.string   "product",                                                        default: "connect",         null: false
    t.string   "branding_switch",                                                                            null: false
    t.boolean  "monthly_billing_enabled",             limit: nil,                default: true,              null: false
    t.string   "cms_token"
    t.string   "cas_server_url"
    t.string   "sso_key",                             limit: 256
    t.string   "sso_login_url"
    t.boolean  "cms_escape_draft_html",               limit: nil,                default: true,              null: false
    t.boolean  "cms_escape_published_html",           limit: nil,                default: true,              null: false
    t.string   "heroku_id"
    t.string   "heroku_name"
    t.boolean  "setup_fee_enabled",                   limit: nil,                default: false
    t.boolean  "account_plans_ui_visible",            limit: nil,                default: false
    t.boolean  "service_plans_ui_visible",            limit: nil,                default: false
    t.string   "skip_email_engagement_footer_switch",                            default: "denied",          null: false
    t.boolean  "end_user_plans_ui_visible",           limit: nil,                default: false
    ...
    t.boolean  "enforce_sso",                         limit: nil,                default: false,             null: false
  end
  ...
  create_table "topics", force: :cascade do |t|
    ...
    t.boolean  "sticky",          limit: nil,                default: false, null: false
    t.integer  "posts_count",                 precision: 38, default: 0
    t.boolean  "locked",          limit: nil,                default: false
  ...
  create_table "web_hooks", force: :cascade do |t|
    t.integer  "account_id",                                  precision: 38
    t.string   "url"
    t.boolean  "account_created_on",              limit: nil,                default: false
    t.boolean  "account_updated_on",              limit: nil,                default: false
    t.boolean  "account_deleted_on",              limit: nil,                default: false
    t.boolean  "user_created_on",                 limit: nil,                default: false
    t.boolean  "user_updated_on",                 limit: nil,                default: false
    t.boolean  "user_deleted_on",                 limit: nil,                default: false
    t.boolean  "application_created_on",          limit: nil,                default: false
    t.boolean  "application_updated_on",          limit: nil,                default: false
    t.boolean  "application_deleted_on",          limit: nil,                default: false
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "provider_actions",                limit: nil,                default: false
    t.boolean  "account_plan_changed_on",         limit: nil,                default: false
    t.boolean  "application_plan_changed_on",     limit: nil,                default: false
    t.boolean  "application_user_key_updated_on", limit: nil,                default: false
    t.boolean  "application_key_created_on",      limit: nil,                default: false
    t.boolean  "application_key_deleted_on",      limit: nil,                default: false
    t.boolean  "active",                          limit: nil,                default: false
    t.boolean  "application_suspended_on",        limit: nil,                default: false
    t.integer  "tenant_id",                                   precision: 38
    t.boolean  "push_application_content_type",   limit: nil,                default: true
